...
public final class HorizontalTrackerDataBinding implements ViewBinding {
  @NonNull
  ...
  private HorizontalTrackerDataBinding(@NonNull RelativeLayout rootView,
  ...
  @NonNull
  public static HorizontalTrackerDataBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static HorizontalTrackerDataBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.horizontal_tracker_data, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static HorizontalTrackerDataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HorizontalTrackerDataBinding((RelativeLayout) rootView, llCompleteStatus,
          rlHorizontalPercentage, txtBtn);
    }
